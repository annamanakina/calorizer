...
public class Constant {
    ...
    public static final String EXTRA_ASTERISK = "*";
    public static final String EXTRA_COMMA = ",";
    public static final String EXTRA_SEMI_COLON = ";";
    public static final String EXTRA_QUOTE = "\"";
    public static final String EXTRA_EQUAL = "=";
